...
task_in_total=$(curl -s https://raw.githubusercontent.com/dylhost/host-ping-test/refs/heads/main/listtest.txt | awk -F ", " -v ipList=$iplist '$4 == ipList {print $0}' | wc -l)
...
done < <((curl -s https://raw.githubusercontent.com/dylhost/host-ping-test/refs/heads/main/listtest.txt | awk -F ", " -v ipList=$iplist '$4 == ipList {print $0}'))
